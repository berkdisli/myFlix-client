...
export class ProfileView extends React.Component {
  ...
  getUser(token) {
    ...
    axios
      .get(`https://berkdislimyflix.herokuapp.com/users/${username}`, {
  ...
  editUser(e) {
    ...
    axios
      .put(
        `https://berkdislimyflix.herokuapp.com/users/${username}`,
        {
  ...
  onRemoveFavorite(id) {
    ...
    axios
      .delete(
        `https://berkdislimyflix.herokuapp.com/users/${username}/favorites/` +
          id,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  onDeleteUser() {
    ...
    const username = localStorage.getItem("user");
    axios
      .delete(`https://berkdislimyflix.herokuapp.com/users/${username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        console.log(response);
...
export default connect(mapStateToProps, { setUser, setUpdateUsers })(
  ProfileView
);
